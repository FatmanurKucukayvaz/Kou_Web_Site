...
<?php
	...
	if(isset($_POST["submit"])){
		...
		$query="SELECT * FROM kullanicilar WHERE kullanici_ad='$kullanici_ad' and sifre='$hashed_sifre'";
		$sonuc=mysql_query($query,$connection);
		while($row=mysql_fetch_array($sonuc)){
			$_SESSION['kullanici']=$row["kullanici_isim"];
			//$_SESSION['kullanici']=$row["kullanici_isim"];
			echo " <meta http-equiv='refresh' content='1;URL=kullanici_sayfasi.php'> ";
			}
	}
?>
<div class="container">    
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        ...
                        <div style="float:right; font-size: 80%; position: relative; top:-10px"><a href="sifredegistir.html">Şifremi Unuttum</a></div>
                    </div>     
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" name="loginform" method="post" action="sistemegiris.php">
